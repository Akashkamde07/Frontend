    ...
    <div>
      ...
      <div className="flex justify-center  flex-col items-center">
        <div className="cont20    mt-28  ) ">
          ...
          <div className=" w-full">
            <h1 className=" font-bold leading-tight tracking-[-0.015em] px-4 text-left pb-3 pt-5">
            ...
            <div>
              <div className="flex flex-col gap-10 px-4 py-10 @container">
                <div className="flex flex-col gap-4">
                  <h1 className="text-left tracking-light text-[32px] font-bold leading-tight @[480px]:text-4xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] max-w-[720px]">
                    Benefits of the Program
                  </h1>
                  <p className="text-left text-base font-normal leading-normal max-w-[720px]">
              ...
              <p className="text-[#0d151c] text-left font-normal leading-normal pb-3 pt-1 px-4">
